...
yydefault:
	...
	case 8:
		...
		{
			yyVAL.stmt = &utils.AssignStmt{Lhs: yyS[yypt-2].exprlist, Rhs: yyS[yypt-0].exprlist}
	...
	case 10:
		...
		{
			yyVAL.stmt = &utils.DoBlockStmt{Stmts: yyS[yypt-1].stmts}
	...
	case 11:
		...
		{
			yyVAL.stmt = &utils.WhileStmt{Condition: yyS[yypt-3].expr, Stmts: yyS[yypt-1].stmts}
	...
	case 12:
		...
		{
			yyVAL.stmt = &utils.RepeatStmt{Condition: yyS[yypt-0].expr, Stmts: yyS[yypt-2].stmts}
			yyVAL.stmt.SetLine(yyS[yypt-3].token.Pos.Line)
			yyVAL.stmt.SetLastLine(yyS[yypt-0].expr.Line())
		}
	case 13:
		{
			yyVAL.stmt = &utils.IfStmt{Condition: yyS[yypt-4].expr, Then: yyS[yypt-2].stmts}
			cur := yyVAL.stmt
	...
	case 14:
		{
			yyVAL.stmt = &utils.IfStmt{Condition: yyS[yypt-6].expr, Then: yyS[yypt-4].stmts}
			cur := yyVAL.stmt
			for _, elseif := range yyS[yypt-3].stmts {
				cur.(*utils.IfStmt).Else = []utils.Stmt{elseif}
				cur = elseif
			}
			cur.(*utils.IfStmt).Else = yyS[yypt-1].stmts
			yyVAL.stmt.SetLine(yyS[yypt-7].token.Pos.Line)
			yyVAL.stmt.SetLastLine(yyS[yypt-0].token.Pos.Line)
		}
	case 15:
		{
			yyVAL.stmt = &utils.NumberForStmt{Name: yyS[yypt-7].token.Str, Init: yyS[yypt-5].expr, Limit: yyS[yypt-3].expr, Stmts: yyS[yypt-1].stmts}
			yyVAL.stmt.SetLine(yyS[yypt-8].token.Pos.Line)
			yyVAL.stmt.SetLastLine(yyS[yypt-0].token.Pos.Line)
		}
	case 16:
		{
			yyVAL.stmt = &utils.NumberForStmt{Name: yyS[yypt-9].token.Str, Init: yyS[yypt-7].expr, Limit: yyS[yypt-5].expr, Step: yyS[yypt-3].expr, Stmts: yyS[yypt-1].stmts}
			yyVAL.stmt.SetLine(yyS[yypt-10].token.Pos.Line)
			yyVAL.stmt.SetLastLine(yyS[yypt-0].token.Pos.Line)
		}
	case 17:
		{
			yyVAL.stmt = &utils.GenericForStmt{Names: yyS[yypt-5].namelist, Exprs: yyS[yypt-3].exprlist, Stmts: yyS[yypt-1].stmts}
	...
	case 18:
		...
		{
			yyVAL.stmt = &utils.FuncDefStmt{Name: yyS[yypt-1].funcname, Func: yyS[yypt-0].funcexpr}
			yyVAL.stmt.SetLine(yyS[yypt-2].token.Pos.Line)
	...
	case 19:
		...
		{
			yyVAL.stmt = &utils.LocalAssignStmt{Names: []string{yyS[yypt-1].token.Str}, Exprs: []utils.Expr{yyS[yypt-0].funcexpr}}
			yyVAL.stmt.SetLine(yyS[yypt-3].token.Pos.Line)
			yyVAL.stmt.SetLastLine(yyS[yypt-0].funcexpr.LastLine())
		}
	case 20:
		...
		{
			yyVAL.stmt = &utils.LocalAssignStmt{Names: yyS[yypt-2].namelist, Exprs: yyS[yypt-0].exprlist}
			yyVAL.stmt.SetLine(yyS[yypt-3].token.Pos.Line)
		}
	case 21:
		//line parser.go.y:187
		{
			yyVAL.stmt = &utils.LocalAssignStmt{Names: yyS[yypt-0].namelist, Exprs: []utils.Expr{}}
	...
	case 23:
		...
		{
			yyVAL.stmts = append(yyS[yypt-4].stmts, &utils.IfStmt{Condition: yyS[yypt-2].expr, Then: yyS[yypt-0].stmts})
			yyVAL.stmts[len(yyVAL.stmts)-1].SetLine(yyS[yypt-3].token.Pos.Line)
		}
	case 24:
		//line parser.go.y:202
		{
			yyVAL.stmt = &utils.ReturnStmt{Exprs: nil}
			yyVAL.stmt.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 25:
		//line parser.go.y:206
		{
			yyVAL.stmt = &utils.ReturnStmt{Exprs: yyS[yypt-0].exprlist}
			yyVAL.stmt.SetLine(yyS[yypt-1].token.Pos.Line)
		}
	case 26:
		//line parser.go.y:210
		{
			yyVAL.stmt = &utils.BreakStmt{}
			yyVAL.stmt.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 27:
	...
	case 28:
		...
		{
			yyVAL.funcname = &utils.FuncName{Func: nil, Receiver: yyS[yypt-2].funcname.Func, Method: yyS[yypt-0].token.Str}
		}
	case 29:
		//line parser.go.y:224
		{
			yyVAL.funcname = &utils.FuncName{Func: &utils.IdentExpr{Value: yyS[yypt-0].token.Str}}
			yyVAL.funcname.Func.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 30:
		//line parser.go.y:228
		{
			key := &utils.StringExpr{Value: yyS[yypt-0].token.Str}
			key.SetLine(yyS[yypt-0].token.Pos.Line)
			fn := &utils.AttrGetExpr{Object: yyS[yypt-2].funcname.Func, Key: key}
			fn.SetLine(yyS[yypt-0].token.Pos.Line)
			yyVAL.funcname = &utils.FuncName{Func: fn}
		}
	case 31:
		//line parser.go.y:237
		{
			yyVAL.exprlist = []utils.Expr{yyS[yypt-0].expr}
		}
	case 32:
	...
	case 33:
		...
		{
			yyVAL.expr = &utils.IdentExpr{Value: yyS[yypt-0].token.Str}
			yyVAL.expr.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 34:
		//line parser.go.y:249
		{
			yyVAL.expr = &utils.AttrGetExpr{Object: yyS[yypt-3].expr, Key: yyS[yypt-1].expr}
	...
	case 35:
		{
			key := &utils.StringExpr{Value: yyS[yypt-0].token.Str}
			key.SetLine(yyS[yypt-0].token.Pos.Line)
			yyVAL.expr = &utils.AttrGetExpr{Object: yyS[yypt-2].expr, Key: key}
	...
	case 40:
		...
		{
			yyVAL.expr = &utils.NilExpr{}
			yyVAL.expr.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 41:
		//line parser.go.y:281
		{
			yyVAL.expr = &utils.FalseExpr{}
			yyVAL.expr.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 42:
		//line parser.go.y:285
		{
			yyVAL.expr = &utils.TrueExpr{}
			yyVAL.expr.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 43:
		//line parser.go.y:289
		{
			yyVAL.expr = &utils.NumberExpr{Value: yyS[yypt-0].token.Str}
			yyVAL.expr.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 44:
		//line parser.go.y:293
		{
			yyVAL.expr = &utils.Comma3Expr{}
			yyVAL.expr.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 45:
	...
	case 49:
		...
		{
			yyVAL.expr = &utils.LogicalOpExpr{Lhs: yyS[yypt-2].expr, Operator: "or", Rhs: yyS[yypt-0].expr}
			yyVAL.expr.SetLine(yyS[yypt-2].expr.Line())
		}
	case 50:
		//line parser.go.y:313
		{
			yyVAL.expr = &utils.LogicalOpExpr{Lhs: yyS[yypt-2].expr, Operator: "and", Rhs: yyS[yypt-0].expr}
			yyVAL.expr.SetLine(yyS[yypt-2].expr.Line())
		}
	case 51:
		//line parser.go.y:317
		{
			yyVAL.expr = &utils.RelationalOpExpr{Lhs: yyS[yypt-2].expr, Operator: ">", Rhs: yyS[yypt-0].expr}
			yyVAL.expr.SetLine(yyS[yypt-2].expr.Line())
		}
	case 52:
	...
	case 57:
		...
		{
			yyVAL.expr = &utils.StringConcatOpExpr{Lhs: yyS[yypt-2].expr, Rhs: yyS[yypt-0].expr}
			yyVAL.expr.SetLine(yyS[yypt-2].expr.Line())
		}
	case 58:
		//line parser.go.y:345
		{
			yyVAL.expr = &utils.ArithmeticOpExpr{Lhs: yyS[yypt-2].expr, Operator: "+", Rhs: yyS[yypt-0].expr}
			yyVAL.expr.SetLine(yyS[yypt-2].expr.Line())
		}
	case 59:
	...
	case 64:
		...
		{
			yyVAL.expr = &utils.UnaryMinusOpExpr{Expr: yyS[yypt-0].expr}
			yyVAL.expr.SetLine(yyS[yypt-0].expr.Line())
		}
	case 65:
		//line parser.go.y:373
		{
			yyVAL.expr = &utils.UnaryNotOpExpr{Expr: yyS[yypt-0].expr}
			yyVAL.expr.SetLine(yyS[yypt-0].expr.Line())
		}
	case 66:
		//line parser.go.y:377
		{
			yyVAL.expr = &utils.UnaryLenOpExpr{Expr: yyS[yypt-0].expr}
			yyVAL.expr.SetLine(yyS[yypt-0].expr.Line())
		}
	case 67:
		//line parser.go.y:383
		{
			yyVAL.expr = &utils.StringExpr{Value: yyS[yypt-0].token.Str}
			yyVAL.expr.SetLine(yyS[yypt-0].token.Pos.Line)
		}
	case 68:
	...
	case 72:
		...
		{
			yyS[yypt-1].expr.(*utils.FuncCallExpr).AdjustRet = true
			yyVAL.expr = yyS[yypt-1].expr
		}
	case 73:
		//line parser.go.y:410
		{
			yyVAL.expr = &utils.FuncCallExpr{Func: yyS[yypt-1].expr, Args: yyS[yypt-0].exprlist}
			yyVAL.expr.SetLine(yyS[yypt-1].expr.Line())
		}
	case 74:
		//line parser.go.y:414
		{
			yyVAL.expr = &utils.FuncCallExpr{Method: yyS[yypt-1].token.Str, Receiver: yyS[yypt-3].expr, Args: yyS[yypt-0].exprlist}
			yyVAL.expr.SetLine(yyS[yypt-3].expr.Line())
		}
	case 75:
	...
	case 79:
		...
		{
			yyVAL.expr = &utils.FunctionExpr{ParList: yyS[yypt-0].funcexpr.ParList, Stmts: yyS[yypt-0].funcexpr.Stmts}
	...
	case 80:
		...
		{
			yyVAL.funcexpr = &utils.FunctionExpr{ParList: yyS[yypt-3].parlist, Stmts: yyS[yypt-1].stmts}
	...
	case 81:
		...
		{
			yyVAL.funcexpr = &utils.FunctionExpr{ParList: &utils.ParList{HasVargs: false, Names: []string{}}, Stmts: yyS[yypt-1].stmts}
	...
	case 82:
		...
		{
			yyVAL.parlist = &utils.ParList{HasVargs: true, Names: []string{}}
		}
	case 83:
		//line parser.go.y:462
		{
			yyVAL.parlist = &utils.ParList{HasVargs: false, Names: []string{}}
	...
	case 85:
		...
		{
			yyVAL.expr = &utils.TableExpr{Fields: []*utils.Field{}}
			yyVAL.expr.SetLine(yyS[yypt-1].token.Pos.Line)
		}
	case 86:
		//line parser.go.y:477
		{
			yyVAL.expr = &utils.TableExpr{Fields: yyS[yypt-1].fieldlist}
			yyVAL.expr.SetLine(yyS[yypt-2].token.Pos.Line)
		}
	case 87:
		//line parser.go.y:484
		{
			yyVAL.fieldlist = []*utils.Field{yyS[yypt-0].field}
		}
	case 88:
	...
	case 90:
		{
			yyVAL.field = &utils.Field{Key: &utils.StringExpr{Value: yyS[yypt-2].token.Str}, Value: yyS[yypt-0].expr}
			yyVAL.field.Key.SetLine(yyS[yypt-2].token.Pos.Line)
		}
	case 91:
		{
			yyVAL.field = &utils.Field{Key: yyS[yypt-3].expr, Value: yyS[yypt-0].expr}
		}
	case 92:
		{
			yyVAL.field = &utils.Field{Value: yyS[yypt-0].expr}
		}
	case 93:
		{
			yyVAL.fieldsep = ","
